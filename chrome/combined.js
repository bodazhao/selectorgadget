      ...
      (K.optgroup = K.option),
        ...
        r.fn.extend({
          ...
          wrapAll: function(e) {
            ...
            if (this[0]) {
              var t = r(e, this[0].ownerDocument)
                .eq(0)
                .clone(!0);
    ...
    (diff_match_patch.prototype.diff_main = function(e, t, n) {
          ...
          return (
            ...
            (e.prototype.selectorGets = function(e, t, n) {
              ...
              try {
                ...
                throw (window.console && console.log("Error on selector: " + n),
                r);
              }
            }),
      ...
      function() {
        ...
        window.SelectorGadget = e = (function() {
          function e() {}
          return (
            (e.prototype.border_width = 5),
            (e.prototype.border_padding = 2),
            (e.prototype.b_top = null),
            (e.prototype.b_left = null),
            (e.prototype.b_right = null),
            (e.prototype.b_bottom = null),
            (e.prototype.selected = []),
            (e.prototype.rejected = []),
            (e.prototype.special_mode = null),
            (e.prototype.path_output_field = null),
            (e.prototype.sg_div = null),
            (e.prototype.ignore_class = "selectorgadget_ignore"),
            (e.prototype.unbound = !1),
            (e.prototype.prediction_helper = new DomPredictionHelper()),
            (e.prototype.restricted_elements = jQuerySG.map(
              ["html", "body", "head", "base"],
              function(e) {
            ...
            (e.prototype.makeBorders = function(e, t) {
              ...
              return (
                ...
                this.b_top
                  .css(
                    "width",
                    this.px(a + this.border_padding * 2 + this.border_width * 2)
                  )
                  .css(
                    "top",
                    this.px(u - this.border_width - this.border_padding)
                  )
                  .css(
                    "left",
                    this.px(i - this.border_padding - this.border_width)
                  ),
                this.b_bottom
                  .css(
                    "width",
                    this.px(
                      a + this.border_padding * 2 + this.border_width * 2 - 5
                    )
                  )
                  .css("top", this.px(u + r + this.border_padding))
                  .css(
                    "left",
                    this.px(i - this.border_padding - this.border_width)
                  )
                  .text(o),
                this.b_left
                  .css("height", this.px(r + this.border_padding * 2))
                  .css("top", this.px(u - this.border_padding))
                  .css(
                    "left",
                    this.px(i - this.border_padding - this.border_width)
                  ),
                this.b_right
                  .css("height", this.px(r + this.border_padding * 2))
                  .css("top", this.px(u - this.border_padding))
                  .css("left", this.px(i + a + this.border_padding)),
                (this.b_right.get(0).target_elem = this.b_left.get(
                  0
                ).target_elem = this.b_top.get(
                  0
                ).target_elem = this.b_bottom.get(0).target_elem = e),
                t ||
                n.hasClass("selectorgadget_suggested") ||
                n.hasClass("selectorgadget_selected")
                  ...
                  : this.b_top.hasClass("selectorgadget_border_red") &&
              ...
              if (!this.b_top)
                return (
                  ...
                  (this.b_bottom = jQuerySG("<div>")
                    ...
                    .css("height", this.px(this.border_width + 6))
                    .hide()
                    .bind("mousedown.sg", { self: this }, this.sgMousedown)),
            ...
            (e.prototype.selectable = function(e) {
              return (
                ...
                (this.css_restriction && jQuerySG(e).is(this.css_restriction))
              );
            }),
            (e.prototype.sgMouseover = function(e) {
              ...
              return (
                ...
                t.unbound
                  ? !0
                  : this === document.body || this === document.body.parentNode
                  ? !1
                  : ((r = jQuerySG(this)),
                    t.unhighlightIframes(),
                    r.is("iframe") && t.highlightIframe(r, e),
                    t.special_mode !== "d"
                      ? ((n = t.firstSelectedOrSuggestedParent(this)),
                        n !== null && n !== this && t.selectable(n)
                          ? t.makeBorders(n, !0)
                          : t.selectable(r) && t.makeBorders(this))
                      : jQuerySG(".selectorgadget_selected", this).get(0) ||
                        (t.selectable(r) && t.makeBorders(this)),
                    !1)
              );
            }),
            (e.prototype.firstSelectedOrSuggestedParent = function(e) {
              ...
              t = e;
              if (
                jQuerySG(e).hasClass("selectorgadget_suggested") ||
                jQuerySG(e).hasClass("selectorgadget_selected")
              )
                return e;
            ...
            (e.prototype.sgMouseout = function(e) {
              ...
              return (
                ...
                n.unbound
                  ...
                  : this === document.body || this === document.body.parentNode
                  ? !1
                  : ((t = jQuerySG(this)), n.removeBorders(), !1)
              );
            }),
            (e.prototype.highlightIframe = function(e, t) {
              ...
              (i = e.offset()),
                ...
                (n = jQuerySG("<div>")
                  ...
                  .css("z-index", "99998")
                  .css("width", this.px(e.outerWidth()))
                  .css("height", this.px(e.outerHeight()))
                  .css("top", this.px(i.top))
                  .css("left", this.px(i.left))
              ...
              return (
                r.append(
                  jQuerySG("<a target='_top'>click here to open it</a>").attr(
                    "href",
                    o
                  )
                ),
                ...
                document.body.appendChild(r.get(0)),
                n.click(function() {
            ...
            (e.prototype.sgMousedown = function(e) {
              ...
              (t = this),
                (s = jQuerySG(t)),
                s.hasClass("selectorgadget_border") &&
                  ((t = t.target_elem || t), (s = jQuerySG(t)));
              if (t === document.body || t === document.body.parentNode) return;
              return (
                n.special_mode !== "d"
                  ? ((r = n.firstSelectedOrSuggestedParent(t)),
                    r !== null && r !== t && ((t = r), (s = jQuerySG(t))))
                  : jQuerySG(".selectorgadget_selected", this).get(0) &&
                    n.blockClicksOn(t),
                n.selectable(s)
                  ? (s.hasClass("selectorgadget_selected")
                      ? (s.removeClass("selectorgadget_selected"),
                        n.selected.splice(jQuerySG.inArray(t, n.selected), 1))
                      : s.hasClass("selectorgadget_rejected")
                      ? (s.removeClass("selectorgadget_rejected"),
                        n.rejected.splice(jQuerySG.inArray(t, n.rejected), 1))
                      : s.hasClass("selectorgadget_suggested")
                      ? (s.addClass("selectorgadget_rejected"),
                        n.rejected.push(t))
                      : (s.addClass("selectorgadget_selected"),
                        n.selected.push(t)),
                    n.clearSuggested(),
                    (i = n.prediction_helper.predictCss(
                      jQuerySG(n.selected),
                      jQuerySG(n.rejected.concat(n.restricted_elements))
                    )),
                    n.suggestPredicted(i),
                    n.setPath(i),
                    n.removeBorders(),
                    n.blockClicksOn(t),
                    s.trigger("mouseover.sg", { self: n }),
                    !1)
                  : (n.removeBorders(), n.blockClicksOn(t), !1)
              );
            }),
            (e.prototype.setupEventHandlers = function() {
              return (
                jQuerySG("*:not(.selectorgadget_ignore)").bind(
                  "mouseover.sg",
                  { self: this },
                  this.sgMouseover
                ),
            ...
            (e.prototype.listenForActionKeys = function(e) {
              ...
              if (e.keyCode === 16 || e.keyCode === 68)
                return (t.special_mode = "d"), t.removeBorders();
            }),
            (e.prototype.clearActionKeys = function(e) {
              var t;
              return (
                (t = e.data.self),
                t.unbound ? !0 : (t.removeBorders(), (t.special_mode = null))
              );
            }),
            (e.prototype.blockClicksOn = function(e) {
              ...
              return (
                ...
                (t = jQuerySG("<div>")
                  ...
                  .css("width", this.px(e.outerWidth()))
                  .css("height", this.px(e.outerHeight()))
                  .css("top", this.px(n.top))
                  .css("left", this.px(n.left))
                  .css("background-color", "")),
                document.body.appendChild(t.get(0)),
                setTimeout(function() {
                  return t.remove();
                }, 400),
                !1
            ...
            (e.prototype.setMode = function(e) {
              return (
                e === "browse"
                  ...
                  : e === "interactive" && this.setupEventHandlers(),
                this.clearSelected()
              );
            }),
                ...
                (t = 0),
                  jQuerySG(e).each(function() {
                    ...
                    if (
                      ...
                      return jQuerySG(this).addClass(
                        "selectorgadget_suggested"
                      );
                  });
                if (this.clear_button)
                  return t > 0
                    ? this.clear_button.attr("value", "Clear (" + t + ")")
            ...
            (e.prototype.setPath = function(e) {
              console.log(e);
              return e && e.length > 0
                ? (this.path_output_field.value = e)
                : (this.path_output_field.value = "No valid path found.");
            }),
            (e.prototype.refreshFromPath = function(e) {
              var t, n;
              return (
                (n = (e && e.data && e.data.self) || this),
                (t = n.path_output_field.value),
                n.clearSelected(),
                n.suggestPredicted(t),
                n.setPath(t)
              );
            }),
            (e.prototype.showXPath = function(e) {
              ...
              return prompt(
                ...
                n.prediction_helper.cssToXPath(t)
              );
            }),
            (e.prototype.clearSelected = function(e) {
              var t;
              return (
                (t = (e && e.data && e.data.self) || this),
                (t.selected = []),
                (t.rejected = []),
                jQuerySG(".selectorgadget_selected").removeClass(
                  "selectorgadget_selected"
                ),
                jQuerySG(".selectorgadget_rejected").removeClass(
            ...
            (e.prototype.updateRemoteInterface = function(e) {
              return this.addScript(
                this.composeRemoteUrl(window.sg_options.remote_interface, e)
              );
            }),
            (e.prototype.composeRemoteUrl = function(e, t) {
              var n, r;
              (r = (e.split("?")[1] && e.split("?")[1].split("&")) || []),
                r.push("t=" + new Date().getTime()),
                r.push("url=" + encodeURIComponent(window.location.href));
              if (t)
                for (n in t)
                  r.push(
              ...
              if (this.remote_data)
                for (n in this.remote_data)
                  r.push(
                    encodeURIComponent("data[" + n + "]") +
                      "=" +
                      encodeURIComponent(this.remote_data[n])
                  );
            ...
            (e.prototype.makeStandardInterface = function() {
              ...
              return (
                ...
                this.sg_div.append(e),
                (this.clear_button = jQuerySG(
                ...
                this.sg_div.append(
                  jQuerySG('<input type="button" value="SEND!"/>')
                    .click(function() {
                      return alert("YOU CLICKED SEND!");
                    })
                    .addClass("selectorgadget_ignore")
                    .addClass("selectorgadget_input_field")
                ),
                this.sg_div.append(
                  jQuerySG('<input type="button" value="Toggle Position"/>')
                    .click(function() {
                      return t.sg_div.hasClass("selectorgadget_top")
                        ? t.sg_div
                ...
                this.sg_div.append(
                  jQuerySG('<input type="button" value="XPath"/>')
                    .bind("click", { self: this }, this.showXPath)
                    .addClass("selectorgadget_ignore")
                    .addClass("selectorgadget_input_field")
                ),
                this.sg_div.append(
                ...
                (this.path_output_field = e.get(0))
              );
            }),
            ...
            (e.prototype.setOutputMode = function(e, t) {
              ...
              return (
                (n = (e && e.data && e.data.self) || this),
                (n.output_mode = (e && e.data && e.data.mode) || t)
              );
            }),
            (e.prototype.rebind = function() {
              return (
                (this.unbound = !1), this.clearEverything(), this.setupBorders()
              );
            }),
            ...
            (e.prototype.analytics = function() {
              ...
              return (
                (o = "UA-148948-9"),
                (u = encodeURIComponent("www.selectorgadget.com")),
                (a = this.randBetween(1e9, 9999999999)),
                (e = this.randBetween(1e7, 99999999)),
                (t = this.randBetween(1e9, 2147483647)),
